...
class AchatValidationRuleTest extends TestCase
{
    ...
    public function test_cannot_create_achat_directly_with_valide_status(): void
    {
        $response = $this->actingAs($this->admin)->post(route('achats.store'), [
            'numero_achat' => 'ACH-2026-VAL',
        ...
        $this->assertDatabaseMissing('achats', ['numero_achat' => 'ACH-2026-VAL']);
    }
