    ...
    return (
        <div className="min-h-screen bg-slate-100 p-4 sm:p-8 text-slate-900 font-sans print:p-0 print:bg-white">
            ...
            <div className="max-w-4xl mx-auto mb-6 flex justify-between items-center bg-white p-4 rounded-xl shadow border border-slate-200 print-hidden-controls print:hidden">
                <div>
                    <h1 className="font-extrabold text-slate-900">{t('print_title')} ({codeAff})</h1>
            ...
            <div className="print-sheet-wrapper max-w-4xl mx-auto bg-white p-10 rounded-2xl shadow-sm border border-slate-200 print:shadow-none print:border-none print:p-0 print:max-w-none">
                ...
                <div className="text-center my-6">
                    ...
                    <p className="text-xs text-slate-400 mt-1.5 font-medium">
                        {t('print_ref')} : <strong className="text-slate-700">{codeAff}</strong> | {t('affectations_date_affectation')} : <strong className="text-slate-700">{formatDate(affectation.date_affectation)}</strong>
                    </p>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="p-4 rounded-xl border border-slate-200 border-l-4 border-l-[#11508f] bg-white text-xs">
                        <div className="grid grid-cols-2 gap-y-2.5 gap-x-6">
                            <div className="flex">
                                <span className="w-28 text-slate-600 font-medium shrink-0">{t('name')} :</span>
                            ...
                            <div className="flex">
                                <span className="w-28 text-slate-600 font-medium shrink-0">{t('services')} :</span>
                            ...
                            <div className="flex col-span-2">
                                <span className="w-28 text-slate-600 font-medium shrink-0">{t('divisions')} / {t('departements')} :</span>
                    ...
                    <table className="w-full text-xs border border-[#11508f] border-collapse text-center">
                        <thead>
                            <tr className="bg-white text-slate-400 font-bold uppercase text-[10px] tracking-wider border-b border-[#11508f]">
                                <th className="p-2.5 border-r border-[#11508f] text-left">{t('materiels_name')}</th>
                                <th className="p-2.5 border-r border-[#11508f]">{t('materiels_category')}</th>
                                <th className="p-2.5 border-r border-[#11508f]">{t('materiels_brand')}</th>
                                <th className="p-2.5 border-r border-[#11508f]">{t('materiels_model')}</th>
                                <th className="p-2.5 border-r border-[#11508f]">{t('materiels_serial')}</th>
                ...
                <div className="mb-6">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <div className="p-4 rounded-xl border border-slate-300 border-t-4 border-t-[#11508f] bg-white min-h-[140px] flex flex-col justify-between text-xs">
                            <div>
                                <div className="font-extrabold uppercase text-[#11508f] font-heading mb-2">{t('print_sig_beneficiary')}</div>
                                <div className="font-bold text-slate-800">{t('name')} : <span className="font-normal">{emp.nom} {emp.prenom}</span></div>
                                <div className="font-bold text-slate-800 mt-1">{t('date')} :</div>
                            </div>
                        ...
                        <div className="p-4 rounded-xl border border-slate-300 border-t-4 border-t-[#11508f] bg-white min-h-[140px] flex flex-col justify-between text-xs">
                            <div>
                                <div className="font-extrabold uppercase text-[#11508f] font-heading mb-2">{t('print_sig_supervisor')}</div>
                        ...
                        <div className="p-4 rounded-xl border border-slate-300 border-t-4 border-t-[#11508f] bg-white min-h-[140px] flex flex-col justify-between text-xs">
                            <div>
                                <div className="font-extrabold uppercase text-[#11508f] font-heading mb-2">{t('print_sig_dsitd')}</div>
                                <div className="font-bold text-slate-800">{t('name')} :</div>
                                <div className="font-bold text-slate-800 mt-1">{t('date')} :</div>
                            </div>
                            <div className="pt-2 border-t border-dashed border-slate-200 text-right text-[10px] italic text-slate-400">
