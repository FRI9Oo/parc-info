...
export default function Dashboard({ stats, recentAffectations }) {
    ...
    const cards = [
        { label: 'Directions', value: stats.directions, href: 'directions.index' },
        { label: 'Départements', value: stats.departements, href: 'departements.index' },
        { label: 'Divisions', value: stats.divisions, href: 'divisions.index' },
        { label: 'Services', value: stats.services, href: 'services.index' },
        { label: 'Employés', value: stats.employes, href: 'employes.index' },
        { label: 'Catégories', value: stats.categories, href: 'categories.index' },
    ];
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <Link href={route('affectations.index')} className="text-indigo-600 text-sm">
                                Voir tout
                            </Link>
                        </div>
